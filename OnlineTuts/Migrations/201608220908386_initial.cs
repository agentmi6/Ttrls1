namespace OnlineTuts.Migrations
{
    ...
    public partial class initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        CommentDateCreated = c.DateTime(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Comments", "TutorialID", "dbo.Tutorials");
            DropForeignKey("dbo.Tutorials", "CategoryID", "dbo.Categories");
            ...
            DropIndex("dbo.Tutorials", new[] { "CategoryID" });
            DropIndex("dbo.AspNetUserRoles", new[] { "RoleId" });
            DropIndex("dbo.AspNetUserRoles", new[] { "UserId" });
            DropIndex("dbo.AspNetUserLogins", new[] { "UserId" });
            DropIndex("dbo.AspNetUserClaims", new[] { "UserId" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.Comments", new[] { "TutorialID" });
