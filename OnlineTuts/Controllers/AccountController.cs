...
namespace OnlineTuts.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LogInRegisterViewModel model, string returnUrl)
        {
            ...
            var result = await SignInManager.PasswordSignInAsync(model.login.UserName, model.login.Password, model.login.RememberMe, shouldLockout: false);
            switch (result)
            {
        ...
        public async Task<ActionResult> Register(LogInRegisterViewModel model)
        {
            using (var context = new ApplicationDbContext())
            {
                ...
                if (ModelState.IsValid)
                {
                    var user = new ApplicationUser { FirstName = model.register.FirstName, UserName = model.register.FirstName, LastName = model.register.LastName, ProfileAvatar = model.register.ProfileAvatar, Email = model.register.Email };
